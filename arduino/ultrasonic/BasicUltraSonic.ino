...
const byte pulse = 22;
const byte dir = 23;
long delay_Micros = 1800;   //CONTROLS STEPPER MOTOR SPEED
...
void loop() {
   ...
   //All the following lines are for stepper motor control. Will eventually be made into a function
